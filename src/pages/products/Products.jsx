...
const Products = () => {
  ...
  const getAllProducts = async () => {
    try {
      ...
      const {data} = await axios.get('https://pos-new-back.herokuapp.com/api/products/getproducts');
      setProductData(data);
      dispatch({
        type: "HIDE_LOADING",
      });
  ...
  const handlerDelete = async (record) => {
    try {
      ...
      await axios.post('https://pos-new-back.herokuapp.com/api/products/deleteproducts', {productId:record._id});
  ...
  const handlerSubmit = async (value) => {
    ...
    if(editProduct === null) {
      try {
        ...
        const res = await axios.post('https://pos-new-back.herokuapp.com/api/products/addproducts', value);
      ...
      try {
       ...
       await axios.put('https://pos-new-back.herokuapp.com/api/products/updateproducts', {...value, productId:editProduct._id});
